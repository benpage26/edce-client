...
class edict(dict):
    ...
    def _wrap(self,
              value):  # from class Struct by XEye '11 http://stackoverflow.com/questions/1305532/convert-python-dict-to-object
    ...
    try:
        ...
        if compress:
            ...
            with open(utf8filename, "w", encoding='utf8') as f:
                decode = bytes(data, "utf-8").decode("unicode_escape")
                f.write(decode)
                f.close()
    except:
